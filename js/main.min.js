...
/* harmony import */ var _modules_slider_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/slider/slider */ "./js/modules/slider/slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_1__["tabs"])();
    Object(_modules_video_video__WEBPACK_IMPORTED_MODULE_2__["default"])();
  });
});
...
var coaches = document.querySelector('.swiper-wrapper--nojs');
var reviews = document.querySelector('.swiper-wrapper--reviews-nojs');
...
window.addEventListener('load', function () {
  ...
  slideDuplicate.forEach(function (duplicate) {
...
/* harmony default export */ __webpack_exports__["default"] = (swiperCoaches, swiperReviews);
...
var tabsContent = document.querySelector('.tabs__content--nojs');
tabsContent.classList.remove('tabs__content--nojs');
var tabsContentInner = document.querySelectorAll('.tabs__content-inner--nojs');
tabsContentInner.forEach(function (contentInner) {
...
document.querySelectorAll('.tabs__item').forEach(function (item) {
  return item.addEventListener('click', function (evt) {
    ...
    document.querySelectorAll('.tabs__item').forEach(function (child) {
      return child.classList.remove('tabs__item--active');
    });
    document.querySelectorAll('.tabs__content-inner').forEach(function (child) {
      return child.classList.remove('tabs__content-inner--active');
    });
